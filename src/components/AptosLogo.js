...
export default function AptosLogo({ onClick, className = "" }) {
  return (
    <div 
    ...
    >
      ...
      <div className="text-center">
        <h1 className="text-sm font-bold tracking-tight flex items-center gap-1">
          <span className="bg-gradient-to-r from-amber-500 to-orange-600 bg-clip-text text-transparent font-extrabold">
            UTC-APT
          </span>
          <span className="text-white font-light">|</span>
          <span className="text-amber-200 font-semibold">FundChain</span>
        </h1>
      </div>
    </div>
  )
