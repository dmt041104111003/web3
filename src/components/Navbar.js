...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed w-full top-0 z-50 transition-all duration-300 ${scrolled ? 'py-2 bg-indigo-700 shadow-lg' : 'py-4 bg-gradient-to-r from-blue-600 to-indigo-700'}`}>
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            ...
            >
              ...
              <span className="ml-2 text-xl font-bold text-white hover:text-blue-100 transition-colors duration-200">Aptos Devnet</span>
            </div>
          </div>
